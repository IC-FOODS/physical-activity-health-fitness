 ...
 * [pahf.yml](pahf.yml)
     * Determines how your purl.obolibrary.org/obo/pahf/ redirects will be handled
     ...
     * Paste in the contents of [pahf.yml](pahf.yml)
 ...
 * [pahf.md](pahf.md)
     ...
     * Paste in the contents of [pahf.md](pahf.md)
     * Click "Commit new file"
     * IMPORTANT: remember to make a pull request
     * An OBO admin will merge your Pull Request *providing it meets the requirements of the OBO library*
